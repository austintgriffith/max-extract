...
*The galaxy is endless, but pirates listen for signals. Without a broadcast, your sector is just another silent void.*

Your first task is to deploy a **Registry Contract** and call broadcast() to announce it to the Extract Protocol. Examine Max’s original contract here [TODO:link] to find the broadcast function you need to call. Note the tx.origin != msg.sender requirement: you can’t call it directly with an EOA. The Extract ledger maps your sector ID to your registry, and your registry will hold a mapping of strings → addresses where you’ll deploy and upgrade to subsequent contracts. [TODO: possible fee in credits or ETH to call broadcast to prevent sybil attacks]
...
- Use this function to broadcast your Registry Contract at your chosen sectorId (uint256 → address) in the Extract Protocol.
...
*Pirates won’t trust words. Only stakes. To enter your garage, they must pledge credits and bind themselves to your code.*
...
*Every pirate carries scars. Some are earned in battle, others in betrayal. A record of reputation must be written for all to see.*
...
*Disorder is when minnows hoard the whale’s feast. Balance is when every ship takes the ore it’s built for.*
...
*Guilds don’t thrive on scraps alone. Debt is the silent backbone of every power that endures.*
...
*Adds flavor, variety, and side revenue — but each brings less overall credits than the basics. They’re crab traps for pirates with specific preferences, giving a small edge but not deciding the game.*

---

### **🗳️ Chapter 6: One Pirate, One Vote**

*Even a guild of cutthroats can’t dodge the ballot. One pirate, one vote — no more, no less.*
...
*Pirates will always gamble. Better they lose to the guild than to the void.*
...
*Pirates break promises. Code does not.*
...
*Your guild won’t shelter every drifter. But that doesn’t mean you can’t profit from them.*
...
*Every pirate’s hand is stained by credits. Some would rather sail unseen.*
