  ...
  return (
    <>
      <div className="flex items-center flex-col grow">
        ...
        <div className="w-full mb-8 -mx-10 relative">
          <Image
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-start pt-32">
            <h1
              className="text-5xl md:text-7xl lg:text-8xl font-bold text-white text-center tracking-wider"
              style={{
                textShadow:
            ...
            {/* Animated Subtitle with Underscores */}
            <div className="mt-[44rem] relative flex justify-center">
              <div
        ...
        <div className="px-5 max-w-6xl mx-auto">
          {/* Story Text */}
          <div className="prose prose-lg max-w-none text-base-content mb-8 px-8 py-6 mt-12">
