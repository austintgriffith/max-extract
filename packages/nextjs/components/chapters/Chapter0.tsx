...
export const Chapter0 = () => {
  ...
  return (
    <div className="bg-base-300 rounded-3xl p-8 mb-6">
      <h2 className="text-3xl font-bold mb-6 text-primary">Chapter 0: The Protocol</h2>
      <div className="space-y-6">
        ...
        <div className="prose prose-lg max-w-none text-base-content">
          ...
          <p className="mb-4">
            ...
            the right to broadcast your own satellite and claim a sector of space. Once you&apos;ve bought in, you
            deploy smart contracts that define the rules and services of your sector. Pilots discover your contracts,
            interact with them, and relay critical data back through the Max Extract system.
          </p>

          <p className="mb-4">
            The protocol generates <strong>rolling round entropy</strong> from universe-wide randomness—like all sectors
            getting a simultaneous dice roll—creating parallel random events across the network that determine when
            pilots get an &ldquo;opening&rdquo; to hyperjump into a system. Each sector has an{" "}
            <strong>airspace classification</strong> (Class 0 through 3) that dictates which{" "}
            <strong>ship models</strong> (A through F) can safely enter. Larger, more rugged ships (Models E and F) can
            handle dangerous Class 0 airspace, while smaller vessels (Models A and B) require the safety of upgraded
            Class 3 sectors. As you progress through the chapters and build out your station infrastructure, your
            airspace classification improves, attracting more diverse pilot traffic.
          </p>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-base-content">
                  ...
                  <strong>killstake transponder</strong> enables automatic slashing of stakes when kills
                  occur—protecting you from point penalties and maintaining order in your sector.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-accent/10 border border-accent rounded-lg p-6">
            ...
            <p className="mb-3">
              You&apos;ll earn points for successful operations and lose points when pilots die in your sector. Your
