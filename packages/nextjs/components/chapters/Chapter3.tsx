    ...
    <div className="space-y-6">
      ...
      <div className="prose prose-lg max-w-none text-base-content">
        ...
        <p className="mb-4">
          ...
          <strong>access control</strong> for your sector. Not all pilots can dock at your station—only those who hold a
          valid <strong>credential NFT</strong>.
        </p>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-base-content">
                A soulbound NFT cannot be transferred or sold after it&apos;s minted. It&apos;s permanently bound to the
                wallet that minted it. This prevents credential sharing and ensures each pilot earns their own access.
              </p>
            </div>
          </div>
        </div>
    ...
    game.pilotMintSectorCredential(YOUR_SECTOR_ID);
        ...
        <div className="bg-base-100 rounded-lg p-4 mb-4 border">
          <ul className="space-y-2 text-sm list-disc list-inside">
            ...
            <li>
              ✅ Verifies <code className="bg-base-100 px-1 rounded">msg.sender</code> matches the registered credential
              contract
            </li>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-base-content mb-3">
                ...
                <strong>each pilot can only mint a credential from each player ONE TIME</strong>. This prevents you from
                farming points by redeploying credential contracts.
              </p>
              <p className="text-sm text-base-content mb-3">
              ...
              <p className="text-sm text-base-content font-semibold">
                Plan your migration strategy if you need to upgrade! Unmigrated pilots will lose access to your sector.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-accent/10 border border-accent rounded-lg p-6">
          ...
          <p className="mb-3">
            Each credential mint earns you <strong>2 points</strong>, and pilots will need valid credentials to land at
            your station and interact with your contracts.
          </p>
