...
export const Chapter2 = () => {
  const { data: auditorContract } = useDeployedContractInfo({ contractName: "Auditor" });
  const auditorAddress = auditorContract?.address;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="prose prose-lg max-w-none text-base-content">
        ...
        <p className="mb-4">
          Now that you have your satellite deployed, it&apos;s time to <strong>announce yourself</strong> to the sector.
          Pilots need to know who you are and how to contact you when they want to share their success stories or
          collaborate on future missions.
        </p>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-base-content">
                When pilots successfully haul in big asteroid scores and escape the sector, they tip the sector registry
                for relaying telemetry data across the Extract Protocol network. Having your details properly mapped to
                the &ldquo;about&rdquo; module <strong>increases your chances of receiving better tips</strong> from
                grateful pilots!
              </p>
            </div>
          </div>
        ...
        <div className="space-y-4 mb-6">
          <div className="flex items-center space-x-4">
            ...
            <p>
              <strong className="text-error">VERIFY</strong> your Announcement contract on the block explorer (required
              before audit)
            </p>
          </div>
          <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-4">
            ...
            <p>
              Check audit status using <code className="bg-base-100 px-2 py-1 rounded text-sm">lastAuditResult</code> on
        ...
        <div className="bg-accent/10 border border-accent rounded-lg p-6">
          ...
          <p className="mb-3">
            Pilots can now see who operates the sector and how to contact you. This increases trust and should result in
            better tips when they successfully escape with big scores.
          </p>
          <p className="text-sm opacity-80">
            <strong>Note:</strong> Your airspace remains <strong>Class 0</strong> at this stage. Only Ship Models E and
            F can still get openings to enter. The next chapter will unlock better airspace classification.
          </p>
        </div>
      </div>
    </div>
