  ...
  return (
    <div className="space-y-6">
      ...
      <div className="prose prose-lg max-w-none text-base-content">
        ...
        <div className="mb-4">
          To participate in the Max Extract Protocol, you need to deploy a <strong>Registry Contract</strong> that calls
          the <code className="bg-base-100 px-2 py-1 rounded text-sm">broadcast</code> function on the MaxExtract
          contract (
          {maxExtractContract && (
...
mapping(string => address) public modules; // Your module registry`}</code>
        ...
        <p className="mb-3">
          Your sector will start as <strong>&ldquo;Class 0&rdquo; airspace</strong>, the most dangerous classification.
          Only the largest, most rugged ships can safely navigate these uncharted conditions.
        </p>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-base-content">
                All pilots must be equipped with a <strong>killswitch transponder</strong> that broadcasts death signals
                to your relay station (your satellite), which relays critical events to the Max Extract system.
              </p>
            </div>
          </div>
        </div>
        ...
        <p className="mb-4">
          The <code className="bg-base-100 px-2 py-1 rounded text-sm">broadcast()</code> function returns your sector ID
          directly, which your registry contract should store. You can also check your sector ID anytime using{" "}
        ...
        <p className="mb-4">
          ...
          <code className="bg-base-100 px-2 py-1 rounded text-sm">broadcast()</code>, this function returns your sector
          ID which your new registry should store.
        </p>
        ...
        <div className="bg-accent/10 border border-accent rounded-lg p-6">
          <p className="mb-3">
            <strong>As soon as you call the broadcast function</strong>, your sector becomes active and pilots can start
            getting openings to enter your airspace!
          </p>
          <p className="mb-3">
          ...
          <p className="mb-3">
            Remember: your sector starts as <strong>Class 0 airspace</strong> - the most dangerous classification. Only
            Ship Models E and F can get clearance to enter. These are the battle-hardened veterans with the most capable
            vessels.
          </p>
          <p>
