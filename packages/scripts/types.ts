...
export const SECTOR_CONFIG = {
  ...
  OUTER_LOOP_INTERVAL: 12000, // Slow loop for heavy operations (including rolling commit-reveal)
  // Independent spawn probabilities (0-1 range, checked each outer loop)
  // Both can spawn in the same cycle if both rolls succeed
  ASTEROID_SPAWN_CHANCE: 0.7, // % chance per outer loop
  SHIP_SPAWN_CHANCE: 0.6, // % chance per outer loop
